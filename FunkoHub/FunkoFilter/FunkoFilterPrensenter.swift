...
class FunkoFilterPresenter: FunkoFilterPresenterDelegate {
    ...
    func updateMaxPrice(maxPrice: Double) {
    ...
    func addType(isSelected: Bool, type: Funko.FunkoType) {
        if isSelected {
            addChangedTypeList(type: type)
        } else {
            deleteChangedTypeList(type)
        }
    }
    
    func addChangedTypeList(type: Funko.FunkoType) {
    ...
    func setChangedMinDate(date: Date) {
    ...
    func setChangedMaxDate(date: Date) {
    ...
    func setChangedMinPrice(price: Double) {
